...
// Remove a neutral (low-saturation) light background — e.g. a baked-in
// transparency checkerboard or flat white — by setting those pixels transparent.
// Coloured / warm subject pixels are kept.
